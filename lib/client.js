  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      function ScopeEditor(props) {
        ...
        // Persist one whole selection. The RPC must never leave the modal
        // stuck on "Saving…": a timeout and a rejection handler both settle
        // the flag and surface a visible error.
        function save(roots) {
